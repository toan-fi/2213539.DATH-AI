...
plt.ylabel('Count')
plt.savefig(os.path.join('/home/llm-researcher/Desktop/HCMUT/HK241/DATH/plots', "dataset label distribution.png"))
plt.show()
plt.close()
...
plt.ylabel('Count')
plt.savefig(os.path.join('/home/llm-researcher/Desktop/HCMUT/HK241/DATH/plots', "dataset review length distribution.png"))
plt.show()
plt.close()
